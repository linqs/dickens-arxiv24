...
EXPERIMENT_HYPERPARAMETER_SEARCH_DIR = os.path.join(RESULTS_BASE_DIR, "unsupervised_hyperparameter_search")
EXPERIMENT_RESULTS_DIR = os.path.join(RESULTS_BASE_DIR, "unsupervised")
...
def _load_args():
    ...
    parser.add_argument('--model', dest='model',
                        action='store', type=str,
                        choices=["mnist-9x9.json", "mnist-9x9-baseline.json"],
