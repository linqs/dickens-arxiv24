...
EXPERIMENT_HYPERPARAMETER_SEARCH_DIR = os.path.join(experiment_utils.LEARNING_RESULTS_BASE_DIR, "semi_supervised_hyperparameter_search")
EXPERIMENT_RESULTS_DIR = os.path.join(experiment_utils.LEARNING_RESULTS_BASE_DIR, "semi_supervised")
...
def main(arguments):
    ...
    if arguments.run_hyperparameter_search:
        assert arguments.model not in ["mnist-add1-baseline.json", "mnist-add2-baseline.json"]
        ...
        experiment_utils.run_wl_experiments_hyperparamter_search(
            ...
            HYPERPARAMETER_SEARCH_TRAIN_SIZES,
            HYPERPARAMETER_SEARCH_UNLABELED_RATIOS,
            base_out_dir
        )
...
def _load_args():
    ...
    parser.add_argument('--model', dest='model',
                        action='store', type=str, required=True,
                        choices=["mnist-add1-semi-supervised.json", "mnist-add1-baseline.json",
                                 "mnist-add2-semi-supervised.json", "mnist-add2-baseline.json"],
